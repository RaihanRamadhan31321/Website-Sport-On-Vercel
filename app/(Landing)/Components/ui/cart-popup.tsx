...
const CartPopup = () => {
    ...
    return <div className="absolute bg-white right-8 top-15 z-10 shadow-xl shadow-black/10 border border-gray-200 w-80">
        <div className="p-2 border-b border-gray-200 font-bold text-center">
            Shopping Cart
        </div> 
